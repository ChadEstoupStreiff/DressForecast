...
def get_clothes_by_day_depending_meteo(meteo_day, all_clothes):
    ...
    if(temp == 3): #+25°
        ...
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["SOCKS"], ["HOT", "MEDIUM", "COLD"], rainList))
        ...
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["SHOES"], ["MEDIUM", "COLD", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["SOCKS"], ["MEDIUM", "COLD", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["PANTS","SKIRT","SHORT"], ["MEDIUM", "COLD", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["TSHIRT"], ["MEDIUM", "COLD", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["PULL"], ["HOT", "MEDIUM", "COLD"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["HAT"], ["MEDIUM"], rainList))
        if(rain>0):
            day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["JACKET"], ["HOT", "MEDIUM", "COLD"], ["BIGRAIN"]))
        ...
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["SHOES"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["SOCKS"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["PANTS","SKIRT","SHORT"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["TSHIRT"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["PULL"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["JACKET"], ["MEDIUM", "HOT", "COLD"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["HAT"], ["COLD"], rainList))
        ...
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["TSHIRT"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["PULL"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["JACKET"], ["COLD", "MEDIUM", "HOT"], rainList))
        day_clothes_list.append(get_clothes_temp_rain(all_clothes, ["HAT"], ["COLD"], rainList))
        #chaussette+chaussures (COLD/MEDIUM//HOT)
        #pants (COLD/MEDIUM//HOT) si existe sinon short ou skirt (COLD/MEDIUM//HOT)
