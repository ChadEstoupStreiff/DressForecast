...
def get_weather_week():
    try: 
        result_bytes = urllib.request.urlopen("https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/paris?unitGroup=metric&key=QFTXUNVHMMAJBHEWDHG7XERWX&contentType=json")
